...
This document lists all known API endpoints from the reference projects:
...
| [ ] | GET | `/wellness-service/wellness/epoch/request/{date}` | Epoch data |
...
| Status | Method | Endpoint | Description |
|--------|--------|----------|-------------|
| [ ] | GET | `/download-service/files/activity/{activityId}` | Download activity (original format) |
...
| Status | Method | Endpoint | Description |
|--------|--------|----------|-------------|
| [ ] | POST | `/upload-service/upload` | Upload activity file |
...
| [ ] | POST | `/usersummary-service/usersummary/hydration/log` | Log hydration |
...
| [ ] | GET | `/metrics-service/metrics/maxmet/daily/{start}/{end}` | Daily max MET |
| [ ] | GET | `/metrics-service/metrics/maxmet/latest/{date}` | Latest max MET |
...
| [ ] | GET | `/device-service/deviceservice/device-info/primary-training-device` | Primary training device |
| [ ] | GET | `/device-service/deviceservice/device-info/solar/{deviceId}?{dates}` | Solar data |
...
Medium priority:
1. Metrics (training readiness, endurance score, etc.)
