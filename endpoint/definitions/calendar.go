...
var CalendarEndpoints = []endpoint.Endpoint{
	{
		...
		Params: []endpoint.Param{
			...
			{Name: "day", Type: endpoint.ParamTypeInt, Required: false, Description: "Day of month (requires month)"},
			{Name: "start", Type: endpoint.ParamTypeInt, Required: false, Description: "Week start day, 1=Monday (requires day)"},
		},
		CLICommand:    "calendar",
		CLISubcommand: "get",
		MCPTool:       "get_calendar",
		Short:         "Get calendar",
		Long:          "Get calendar items including activities, workouts, and weight entries. Parameters are hierarchical: month requires year, day requires month, start requires day.",
